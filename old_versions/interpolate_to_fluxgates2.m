...
%     clear Dmed Dmad;
    ...
    title ('Discharge (m^3/yr)'); fontSize = 18;
    xlabel('Year'); ylabel('Discharge (m^3)'); fontSize = 18;
    subplot(sub2);
    plot(nanmean(max(gate_vel,[],2,'includenan')),nanmean(D),'x','linewidth',1.5,'color',cmap(i,:)); hold on; grid on; drawnow;
    title ('Discharge (m^3/yr) vs Velocity'); fontSize = 18;
    xlabel('Velocity (m/yr)'); ylabel('Discharge (m^3/yr)'); fontSize = 18;
    subplot(sub3);
    ...
    title ('Discharge (m^3/yr) vs Fluxgate width (m)'); fontSize = 18;
    xlabel('Gate width (m)'); ylabel('Discharge (m^3/yr)'); fontSize = 18;
