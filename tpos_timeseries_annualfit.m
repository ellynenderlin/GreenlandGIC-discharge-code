...
% imagesc(GIMP.x,GIMP.y,2*GIMP.ice+GIMP.land); axis xy equal; 
% map_cmap = [1 1 1; 0.5 0.5 0.5; 0 1 1]; colormap(map_cmap); hold on;

cd ../Greenland-ITSLIVE_1985-2018/
...
%             subplot(subW); 
            ...
            if (29+(k-2014+1)) <= length(term(boxref).fluxVelavg)
                Waccel(i,k-2013) = (term(boxref).fluxVelavg(29+(k-2014+1))-term(boxref).fluxVelavg(29+(k-2014)));
            end
...
%             subplot(subN); 
            ...
            if (29+(k-2014+1)) <= length(term(boxref).fluxVelavg)
                Naccel(i,k-2013) = (term(boxref).fluxVelavg(29+(k-2014+1))-term(boxref).fluxVelavg(29+(k-2014)));
            end
...
%             subplot(subNE); 
            ...
            if (29+(k-2014+1)) <= length(term(boxref).fluxVelavg)
                NEaccel(i,k-2013) = (term(boxref).fluxVelavg(29+(k-2014+1))-term(boxref).fluxVelavg(29+(k-2014)));
            end
...
%             subplot(subCE); 
            ...
            if (29+(k-2014+1)) <= length(term(boxref).fluxVelavg)
                CEaccel(i,k-2013) = (term(boxref).fluxVelavg(29+(k-2014+1))-term(boxref).fluxVelavg(29+(k-2014)));
            end
        else
%             subplot(subSE); 
            ...
            if (29+(k-2014+1)) <= length(term(boxref).fluxVelavg)
                SEaccel(i,k-2013) = (term(boxref).fluxVelavg(29+(k-2014+1))-term(boxref).fluxVelavg(29+(k-2014)));
            end
        end
...
% set(subW,'ylim',[-1 1]); set(subN,'ylim',[-1 1]); set(subNE,'ylim',[-1 1]); set(subCE,'ylim',[-1 1]); set(subSE,'ylim',[-1 1]); 

%box plots of annual slopes (retreat rates)
figure; set(gcf,'position',[850 50 600 1200]);
subplot(5,1,1);
boxplot(-Wslope,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-4 4],'ytick',[-4:2:4],'fontsize',18);
subplot(5,1,2);
boxplot(-Nslope,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-4 4],'ytick',[-4:2:4],'fontsize',18);
subplot(5,1,3);
boxplot(-NEslope,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-4 4],'ytick',[-4:2:4],'fontsize',18);
subplot(5,1,4);
boxplot(-CEslope,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-4 4],'ytick',[-4:2:4],'fontsize',18);
subplot(5,1,5);
boxplot(-SEslope,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-4 4],'ytick',[-4:2:4],'fontsize',18);
xlabel('Year','fontsize',20); 
ylbl = ylabel('Terminus retreat rate (m/d)','fontsize',20); set(ylbl,'position',[0.1071 30 -1]);
...
subplot(5,1,1);
boxplot(Waccel,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-13 13],'ytick',[-12:4:12],'fontsize',18);
subplot(5,1,2);
boxplot(Naccel,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-13 13],'ytick',[-12:4:12],'fontsize',18);
subplot(5,1,3);
boxplot(NEaccel,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-13 13],'ytick',[-12:4:12],'fontsize',18);
subplot(5,1,4);
boxplot(CEaccel,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-13 13],'ytick',[-12:4:12],'fontsize',18);
subplot(5,1,5);
boxplot(SEaccel,'Labels',{'2014', '2015','2016','2017','2018','2019','2020'}); set(gca,'ylim',[-13 13],'ytick',[-12:4:12],'fontsize',18);
xlabel('Year','fontsize',20); 
...
%plot regional median & IQR (or MAD) terminus change rate time series on left axis
%and velocity time series on the right axis
